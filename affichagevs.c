...
char* get_name_from_mouse(int choix, int* x, int* y, Pokemon poke, Pokemon** poke1, Pokemon** poke2){
    ...
    SDL_Rect atkb = {53, 72, 233, 104};         
    SDL_Rect spe1 = {313, 72, 233, 104};        
    SDL_Rect spe2 = {563, 72, 233, 104};         
    SDL_Rect spe3 = {53, 72, 233, 834};        
...
void aff_atk_fight(Pokemon* poke, SDL_Renderer* renderer, SDL_Window* window){
}
